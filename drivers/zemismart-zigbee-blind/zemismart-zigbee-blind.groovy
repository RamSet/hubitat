...
void endOfMovement() {
    ...
    Integer lastPos = device.currentValue('position', true) as Integer
    Integer target = (state.target != null) ? (state.target as Integer) : null
    ...
    updateWindowShadeArrived(lastPos != null ? lastPos : INVALID_POSITION)
}
