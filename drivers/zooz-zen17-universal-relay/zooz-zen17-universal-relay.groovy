...
## [1.3.2-rs4] - 2026-08-21 (RamSet fork)
  - Added "Invert Sw<N> Sensor Reporting" preference, shown for any Sw input set
    ...
    their contacts when wet) otherwise report backwards, and the ZEN17 has no
...
## [1.3.2-rs3] - 2026-06-13 (RamSet fork)
  - Documented a confirmed gotcha: configuring an Sw input as a SENSOR type
    ...
    it. Input-type parameter descriptions updated to say so.
...
metadata {
	...
	preferences {
		...
		// sensors OPEN their contacts when wet) makes the relay report the input
