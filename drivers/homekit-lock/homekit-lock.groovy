 ...
 */
metadata {
    definition(name: "HomeKit HAP Lock", namespace: "RamSet", author: "RamSet", importUrl: "https://raw.githubusercontent.com/RamSet/hubitat/main/drivers/homekit-lock/homekit-lock.groovy") {
        capability "Lock"
        capability "Battery"
        capability "Refresh"
