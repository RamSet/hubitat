 ...
 */
metadata {
    definition(name: "HomeKit HAP Lock", namespace: "RamSet", author: "RamSet", importUrl: "http://10.33.47.84/api/v1/repos/RamSet/hubitat-homekit-import/raw/drivers/homekit-lock/homekit-lock.groovy?token=8813b22a89d3c96578b1eca8a56c2f8e6c2b3561") {
        capability "Lock"
        capability "Battery"
        capability "Refresh"
